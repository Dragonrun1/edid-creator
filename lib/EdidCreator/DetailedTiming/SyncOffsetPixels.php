<?php
/**
 * Contains SyncOffsetPixels class.
 *
 * PHP version 5.3
 *
 * LICENSE:
...
/**
 * Class SyncOffsetPixels
 *
 * @package EdidCreator\DetailedTiming
 */
class SyncOffsetPixels extends AbstractDetailedTimingComponent
{
    /**
     ...
     * @return string
     */
    public function getSyncOffsetPixels()
    {
        $offset = array($this->byteOffset + 11, 6);
