 ...
 */
class BorderLines extends AbstractDetailedTimingComponent
{
    /**
     ...
     * @return self
     */
    public function setBorderLines($value)
    {
        $offset = array($this->byteOffset + 16, 0);
     ...
     * @return string
     */
    public function getBorderLines()
    {
        $offset = array($this->byteOffset + 16, 0);
