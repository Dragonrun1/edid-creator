<?php
/**
 * Contains AbstractDetailedTimingComponent class.
 *
 * PHP version 5.3
 *
 * LICENSE:
...
/**
 * Class AbstractDetailedTimingComponent
 *
 * @package EdidCreator\DetailedTiming
 */
abstract class AbstractDetailedTimingComponent implements EdidAwareInterface, EdidComponentInterface
{
    /**
     * @param int                        $position
